myApp.controller('registerController', ['$scope','userFactory', '$location', function($scope, userFactory, $location) {
    ...
    $scope.register = function(){
    	...
    	userFactory.register({first_name: $scope.first_name, last_name: $scope.last_name, email: $scope.email, password: $scope.password, birthday: $scope.birthday}, function(data){
